...
// These classes place the five entry cards around the ring
const ringPositions = [
  "is-front",
  "is-right-front",
  "is-right-back",
...
// Move every card into its new position when the selected path changes
...
// A side card moves to the front first; clicking the front card opens its section
...
// The opening prompt scrolls down to the path selector.
if (beginLink) {
...
window.initialiseHomeModule = initialiseHomeModule;